...
public class FloorTest {
    ...
    private static final Floor.Builder FLOOR= Floor.builder().id(ID).mnemonic(MNEMONIC).parkingLotId(PARKING_LOT_ID).parkingLot(PARKING_LOT);
    ...
    void testGetParkingLotId() {
        Floor floor= FLOOR.build();
        assertEquals(PARKING_LOT_ID,floor.getParkingLotId());
